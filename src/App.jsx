...
function App() {
  ...
  const handleAuth = async (form) => {
    ...
    try {
      ...
      setAuthOpen(false)
      showToast(authMode === 'signup' ? 'Account created successfully' : 'Welcome back to Adama Eats')
    } catch (error) {
